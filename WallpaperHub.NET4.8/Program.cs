...
namespace WallpaperHubConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            String wallpaperLink = "https://wallpaperhub.app/api/v1/get/" + wallpaperCode;
            Console.WriteLine(wallpaperLink);
            DownloadWallpaper(wallpaperLink, FileName(wallpaperCode));
            //Console.WriteLine(FileName(wallpaperCode));
            Console.ReadKey();

            //WallpaperSelector(wallpaperCode);
        }

        public static void cropImage(Bitmap img)
        {
            Bitmap nb = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height);
            Graphics g = Graphics.FromImage(nb);
            g.DrawImage(img, -Screen.PrimaryScreen.Bounds.X, -Screen.PrimaryScreen.Bounds.Y);
            nb.Save("C:\\Users\\" + Environment.UserName + "\\Desktop\\wallpaper.jpg", ImageFormat.Jpeg);
            //return nb;
        }
        ...
        public static void DownloadWallpaper(string wallpaperLink, string fileName)
        {
            using (var client = new WebClient())
            {
                ...
                image.Dispose();
                newImage.Dispose();
                Console.WriteLine("Wallpaper Downloaded to Desktop");
                Console.ReadKey();
        ...
        public static void wallpaperExist(String url) {
            try
            {
                //String url = "https://wallpaperhub.app/api/v1/get/10275";
